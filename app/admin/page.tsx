      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{revenueData.foodCount}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{revenueData.userCount}</div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          ...
          <TabsContent value="food-items" className="space-y-4">
            <AdminFoodItems onFoodAdd={fetchStatistics} />
          </TabsContent>
          ...
          <TabsContent value="users" className="space-y-4">
            <AdminUsers onUserAdd={fetchStatistics} />
          </TabsContent>
